...
public class TagController : ControllerBase
{
    ...
    // To protect from overposting attacks, see https://go.microsoft.com/fwlink/?linkid=2123754
    [HttpPost]
    public async Task<ActionResult<Tag>> PostTag([FromForm] TagRequest data)
    {
        var name = data.name;
        ...
        await _context.SaveChangesAsync();
        return CreatedAtAction("GetTag", new {id = tag.TagId}, tag.TagId);
    }
    ...
    // DELETE: api/Tag/all
    [HttpDelete("all")]
    public async Task<IActionResult> DeleteTagAll()
    {
